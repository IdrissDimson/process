...
This week, I would alos like to gain feedback back from the playtesters to see if the mechanics need to be tweaked or if anything didn't make any sense while playing. Would also like to test to see if a shooting mechanic for the player would be necessary.